...
REFERENCE PHOTOS: the owner may send images. Infer why from their words + the image. A photo of a handwritten/printed specials list → read it carefully and transcribe items and prices. A dish or style photo → use it to inform naming, wording, colors, or which theme best matches the vibe. If you truly can't tell what they want, ask one short clarifying question.
