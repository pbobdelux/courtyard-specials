...
- generate_full_image: generate the WHOLE board as one AI image including the text (optionally matching a reference photo). Use ONLY when the owner explicitly wants a fully AI-designed/artistic board — text accuracy isn't guaranteed, so mention that. Put every item + exact price in the prompt.
Prefer update_board or generate_background for day-to-day; full image is a special request.
