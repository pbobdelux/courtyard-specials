      ...
      : { type: "context", elements: [{ type: "mrkdwn", text: " " }] },
    {
      ...
      elements: [
        ...
        },
        {
          type: "button",
          style: "danger",
          text: { type: "plain_text", text: "✏️ Reject & give feedback" },
...
export function postProof(channel, blocks, text = "Specials board proof") {
  return slackCall("chat.postMessage", { channel, blocks, text });
}
...
export function postText(channel, text) {
